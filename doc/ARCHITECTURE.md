...
- Reading topic selection uses 2-Session Blocked LRR Streak Rotation: active notebooks complete a 2-session block before rotating to the least-recently-read notebook of equal priority.
