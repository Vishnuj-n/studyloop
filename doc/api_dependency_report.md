...
| `MakeAllFlashcardsDueNow` | `internal\db\flashcard_repo.go:507` | `Repository` | `method` |
...
| `buildReviewTaskForPlan` | `internal\app\app_study.go:282` | None | `function` |
...
| `calculateStreak` | `internal\app\app_study.go:87` | None | `function` |
...
| `computeCurrentStreak` | `internal\app\app_study.go:143` | None | `function` |
| `computeLongestStreak` | `internal\app\app_study.go:113` | None | `function` |
...
| `emitIngestionProgress` | `internal\app\notebook_endpoints.go:1041` | None | `function` |
| `envHasLLMAPIKey` | `internal\app\app_settings.go:315` | None | `function` |
...
| `mapTaskError` | `internal\app\app_study.go:166` | None | `function` |
...
| `normalizeLLMTierForApp` | `internal\app\app_settings.go:305` | None | `function` |
...
| `queueTaskToScheduledTask` | `internal\app\app_study.go:313` | None | `function` |
| `reconcileConfirmedNotebookTask` | `internal/app/app.go` | `App` | `AppHelper` |
| `reloadLLMProviders` | `internal/app/app.go` | `App` | `AppHelper` |
| `requireRepo` | `internal\app\app_study.go:184` | None | `function` |
...
| `sameLLMSettingsForUI` | `internal\app\app_settings.go:329` | None | `function` |
