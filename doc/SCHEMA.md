...
| `streak_freezes_owned` | INTEGER NOT NULL DEFAULT 1 | Available streak freeze shields (capped at 2 max) |
| `last_freeze_purchased_at` | INTEGER NOT NULL DEFAULT 0 | Unix timestamp of last streak freeze purchase (rate limit 1/week) |
