...
const themes = [
  ...
  { id: 'dark-academia', label: 'Dark Academia', bg: '#1c1917', primary: '#d97706', surface: '#292524' },
  { id: 'dark-cyberpunk', label: 'Neon Cyberpunk', bg: '#090714', primary: '#ff007f', surface: '#161228' },
  { id: 'light-zen', label: 'Zen Minimalist', bg: '#f5f5f0', primary: '#44403c', surface: '#e5e5df' },
