...
def main():
    ...
    lines.append("<!-- Generated by: python scripts/analyze_api_dependency_graph.py --output doc/api_dependency_report.md -->")
    lines.append("<!-- Any manual changes will be overwritten. To update, re-run the generator script. -->\n")
    ...
    lines.append("<!-- DO NOT EDIT: Auto-generated from AST reachability analysis -->")
